-- HA recorder schema (subset) for MySQL / MariaDB
-- Apply: mysql -h 127.0.0.1 -P 3307 -u root -psecret hass < tests/schema.mysql.sql
...
CREATE TABLE event_types (
    event_type_id BIGINT AUTO_INCREMENT PRIMARY KEY,

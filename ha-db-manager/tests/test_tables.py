...
async def test_list_tables(client):
    ...
    assert "statistic_id" in by_name["statistics_meta"]["links"]
    assert "metadata_id" not in by_name["statistics_meta"]["links"]  # not a link in the Statistics view
    assert "event_type" in by_name["event_types"]["links"]
    assert "event_type_id" not in by_name["event_types"]["links"]  # not a link in the Events view
